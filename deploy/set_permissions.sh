...
set_dir_permissions "${PROJECT_DIR}/scripts/python" "755" "Python scripts directory"
set_dir_permissions "${PROJECT_DIR}/scripts/python/pyutils" "755" "Python utils directory"
...
verify_permissions "${PROJECT_DIR}/scripts/python" "755" "Python scripts directory"
