...
deploy_multi_chain() {
    ...
    # Run deployment script
    bash "$SCRIPT_DIR/deploy_prod_multi_chain.sh"
...
backup_config() {
    ...
    # Run backup script
    bash "$SCRIPT_DIR/backup_config.sh"
...
verify_deployment() {
    ...
    if [ -n "$CHAINS" ]; then
        bash "$SCRIPT_DIR/verify_multi_chain.sh"
    else
...
emergency_shutdown() {
    ...
    bash "$SCRIPT_DIR/emergency_shutdown.sh"
...
verify_integration() {
    ...
    bash "$SCRIPT_DIR/verify_integration.sh"
