...
class TestChainSettings:
    ...
    def test_chain_settings_missing_required_fields(self):
        ...
        assert (
            "field required" in error_messages.lower()
            or "missing" in error_messages.lower()
        )
...
class TestMultiChainSettings:
    ...
    def test_multi_chain_settings_with_chains(self):
        ...
        chain1 = ChainSettings(
            name="ethereum", chain_id=1, http_endpoint="https://eth.rpc.com"
        )
        chain2 = ChainSettings(
            name="polygon", chain_id=137, http_endpoint="https://polygon.rpc.com"
        )

        settings = MultiChainSettings(chains={"ethereum": chain1, "polygon": chain2})
    ...
    def test_multi_chain_settings_json_serialization(self):
        ...
        chain = ChainSettings(
            name="test", chain_id=42, http_endpoint="https://test.com"
        )
...
class TestModelIntegration:
    ...
    def test_complex_configuration_scenario(self):
        ...
        api_settings = APISettings(
            infura_project_id="test_project", etherscan_api_key="test_eth_key"
        )
        ...
        global_settings = GlobalSettings(debug=True, base_path="/app")
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_empty_string_fields(self):
        ...
        settings = ChainSettings(
            name="", chain_id=1, http_endpoint="https://test.com"  # Empty string
        )
    ...
    def test_none_vs_missing_fields(self):
        ...
        settings2 = ChainSettings(
            name="test", chain_id=1, http_endpoint="https://test.com"
        )
    ...
    def test_model_copy_and_update(self):
        ...
        original = ChainSettings(
            name="original", chain_id=1, http_endpoint="https://original.com"
        )
        ...
        assert (
            updated.http_endpoint == "https://original.com"
