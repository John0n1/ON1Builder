...
class TestStrategyExecutor:
    ...
    async def test_market_state_analysis(self, strategy_executor):
        ...
        arbitrage_adjustment = await strategy_executor._get_market_condition_adjustment(
            "arbitrage"
        )
...
class TestExternalAPIs:
    ...
    async def test_price_fetching(self, api_manager):
        ...
        with patch.object(
            api_manager,
            "_fetch_price_from_provider",
            new_callable=AsyncMock,
            return_value=2500.50,
        ):
    ...
    async def test_volume_fetching(self, api_manager):
        ...
        with patch.object(
            api_manager,
            "_fetch_volume_from_provider",
            new_callable=AsyncMock,
            return_value=15000000000.0,
        ):
...
class TestTransactionManager:
    ...
    def mock_web3(self):
        ...
        mock_web3.eth.get_code = AsyncMock(
            return_value=b"\x60\x60\x40"
        )  # Non-empty bytecode
    ...
    def transaction_manager(self, mock_config, mock_web3, mock_account):
        ...
        return TransactionManager(
            web3=mock_web3, account=mock_account, configuration=mock_config
        )
    ...
    async def test_simulate_transaction(self, transaction_manager, mock_web3):
        ...
        success, error_msg, sim_data = await transaction_manager.simulate_transaction(
            tx
        )
        ...
        expected_checksum = Web3.to_checksum_address(
            "0x742d35cc6251c2e4b64c5b5d8a75b5d5b5b5b5b5"
        )
...
class TestConfigurationSystem:
    ...
    def test_pydantic_validation(self):
        ...
        from on1builder.config.settings import ChainSettings, GlobalSettings

        # Test valid configuration
        valid_config = {"debug": True, "database_url": "sqlite:///test.db"}
...
async def run_functional_tests():
    ...
    try:
        ...
        print(
            "✅ StrategyExecutor class imports successfully (full test requires dependency injection)"
        )
