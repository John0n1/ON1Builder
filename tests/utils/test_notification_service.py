...
class TestNotificationService:
    ...
    def test_init_with_main_orchestrator(self, mock_config):
        ...
        service = NotificationService(
            config=mock_config, main_orchestrator=mock_orchestrator
        )

        assert service.main_orchestrator == mock_orchestrator

    @patch.dict(os.environ, {"SLACK_WEBHOOK_URL": "https://hooks.slack.com/env_test"})
    ...
    @patch.dict(os.environ, {"SMTP_SERVER": "smtp.env.com"})
